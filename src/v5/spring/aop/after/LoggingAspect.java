...
public class LoggingAspect {
	 ...
	 */
	@AfterReturning(pointcut="execution(public String v5.spring.aop.after.TriangleModel.getName())", returning="returningString")
	 ...
	 * @param returningString
	 */
	@AfterThrowing(pointcut="execution(public String v5.spring.aop.after.TriangleModel.getNameWithException())", throwing="ex")
